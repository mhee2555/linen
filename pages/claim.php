  ...
  $(document).ready(function(e){
    ...
    function DeleteItem(){
      ...
      swal({
        ...
        text: "<?php echo $array['confirmdelete1'][$language]; ?>"+xrow[1]+"<?php echo $array['confirmdelete2'][$language]; ?>",
        type: "warning",
              ...
              success: function (result) {
                ...
                if(temp["status"]=='success'){
                  if(temp["form"]=='OnLoadPage'){
                    ...
                    var st1 = "style='font-size:24px;margin-left:30px; width:130px;font-family:THSarabunNew'";
                    for (var i = 0; i < temp["Row"]; i++) {
                      ...
                      var Weight = "<div class='row' style='margin-left:2px;'><input class='form-control' style='height:40px;width:110px; margin-left:3px; margin-right:3px; text-align:center;' id='weight_"+i+"' value='"+temp[i]['Weight']+"' OnBlur='updateWeight(\""+i+"\",\""+temp[i]['RowID']+"\")'></div>";
                      ...
                      "<td style='width: 6%;'>"+chkDoc+" <label style='margin-left:10px;'> "+(i+1)+"</label></td>"+
                      "<td style='width: 14%;'>"+temp[i]['ItemCode']+"</td>"+
                      "<td style='width: 20%;'>"+temp[i]['ItemName']+"</td>"+
                      "<td style='width: 17%;' align='center'>"+chkunit+"</td>"+
                      "<td style='width: 15%;' align='center'>"+Qty+OleQty+"</td>"+
                      "<td style='width: 10%;' align='center'>"+Weight+"</td>"+
                      "<td style='width: 17%;' align='center'>"+Price+"</td>"+
                      "</tr>";
                      if(rowCount == 0){
                            ...
                            <table style="margin-top:10px;" class="table table-fixed table-condensed table-striped" id="TableItemDetail" width="100%" cellspacing="0" role="grid" style="">
                              <thead id="theadsum" style="font-size:24px;">
                                <tr role="row">
                                  ...
                                  <th style='width: 11%;'><center><?php echo $array['unit'][$language]; ?></center></th>
                                  <th style='width: 15%;'><center><?php echo $array['total'][$language]; ?></center></th>
                                  <th style='width: 14%;'><center><?php echo $array['weight'][$language]; ?></center></th>
                                  <th style='width: 15%;'><center><?php echo $array['money'][$language]; ?></center></th>
                                </tr>
                              </thead>
                              ...
                              <div class="card-body" style="padding:0px; margin-top:10px;">
                                ...
                                <div class="row" style="margin-top:4px;">
                                  <div class="col-md-1">
                                    <div class="row" style="margin-left:2px;">
                                      <div class="row" style="margin-left:30px;">
                                        <button onclick="SaveBill()" style="width:105px" type="button" class="btn btn-success" onclick="AddItem()" id="bSave"><?php echo $array['save'][$language]; ?></button>
                                      </div>
                                    </div>
                                  </div>
                                </div>
                                ...
                                <div class="row" style="margin-top:4px;">
                                  <div class="col-md-1">
                                    <div class="row" style="margin-left:2px;">
                                      <div class="row" style="margin-left:30px;">
                                        <button style="width:105px"; type="button" class="btn btn-danger" onclick="CancelBill()" id="bCancel"><?php echo $array['cancel'][$language]; ?></button>
                                      </div>
                                    </div>
                                  </div>
                                </div>
                                <div class="row" style="margin-top:4px;">
                                  <div class="col-md-1">
                                    <div class="row" style="margin-left:2px;">
                                      <div class="row" style="margin-left:30px;">
                                        <button style="width:105px"; type="button" class="btn btn-primary" onclick="PrintData()" id="bPrint"><?php echo $array['printbill'][$language]; ?></button>
                                      </div>
                                    </div>
                                  </div>
                                </div>
