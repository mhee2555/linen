...
function ShowDocument($conn, $DATA)
{
  ...
  // mysqli_query($conn,$Sql);
  $Sql = "SELECT side.HptName,department.DepName,factory_out.DocNo,factory_out.DocDate,factory_out.RefDocNo,factory_out.Total,users.FName,TIME(factory_out.Modify_Date) AS xTime,factory_out.IsStatus
FROM factory_out
INNER JOIN department ON factory_out.DepCode = department.DepCode
...
function SelectDocument($conn, $DATA)
{
  ...
  $DocNo = $DATA["xdocno"];
  $Datepicker = $DATA["Datepicker"];
  $Sql = "SELECT   side.HptName,department.DepName,factory_out.DocNo,factory_out.DocDate,factory_out.Total,users.FName,TIME(factory_out.Modify_Date) AS xTime,factory_out.IsStatus,factory_out.RefDocNo
FROM factory_out
INNER JOIN department ON factory_out.DepCode = department.DepCode
INNER JOIN side ON department.HptCode = side.HptCode
INNER JOIN users ON factory_out.Modify_Code = users.ID
